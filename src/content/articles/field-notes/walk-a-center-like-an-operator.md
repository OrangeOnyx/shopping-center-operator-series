---
title: "How to walk a center like an operator"
deck: "Skip the lobby. Start at the median opening, count stalls, then walk the service street. The front is marketing. The back is the truth."
...
# How to walk a center like an operator
...
Do not trust the aerial. Mature oaks hide overflow lots. Unlabeled head-in rows disappear in drone shots. Walk the field with the variance number in your head — here, 324 provided against 344 required — and then count what is actually striped. Ops planning on the plat total (314) is not the same as citing the legal variance (324). Hold both numbers. Do not round them together.
